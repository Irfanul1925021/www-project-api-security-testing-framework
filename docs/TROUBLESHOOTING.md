...
The release workflow runs the full test suite before building the JAR. If any of the 371 tests fail, the release is aborted — no JAR is published and no GitHub Release is created.  
